...
private func highlightLink(str: NSString, withColor color: UIColor) -> NSAttributedString {
    let start = str.rangeOfString("<")
    if start.location == NSNotFound {
        return NSAttributedString(string: str as String)
    }

    var s: NSString = str.stringByReplacingCharactersInRange(start, withString: "")
